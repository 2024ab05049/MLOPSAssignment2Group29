...
- Review MLflow logs for training issues
- Check Kubernetes logs for deployment issues

## Demo Video Instructions

To create the 5-minute demo video, cover:
...
5. **CI/CD Pipeline** (1.5 min)
   ...
   - Demonstrate code push triggering CI
   - Show automated tests running
   - Show Docker image being built and pushed

6. **Deployment & Monitoring** (1 min)
   - Deploy to Kubernetes/Docker Compose
   - Run smoke tests
   - Show Prometheus metrics
   - Show API statistics and logs
...
**Built with ❤️ for MLOps Pipeline Assignment**
